...
<body class="font-sans bg-brand-50 min-h-screen flex items-center justify-center px-4 py-12">
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-2xl shadow-brand-500/10 px-8 py-10 sm:px-10">
            ...
            <h1 class="font-serif text-2xl font-bold text-dark text-center mb-6">Selamat Datang Kembali</h1>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2 text-sm text-gray-500 cursor-pointer">
                        <input type="checkbox" name="remember" class="w-4 h-4 rounded border-gray-300 text-brand-500 focus:ring-brand-400">
                        Ingat saya
                    </label>
                </div>
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Belum punya akun?
                <a href="{{ route('register') }}" class="font-semibold text-brand-500 hover:text-brand-600 transition-colors">Daftar sekarang</a>
            </p>
