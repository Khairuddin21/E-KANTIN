...
<body class="font-sans bg-gray-50 text-dark antialiased">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-sidebar text-white z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col">
        ...
        <nav class="flex-1 px-4 py-5 overflow-y-auto space-y-5">
            ...
            {{-- OPERASIONAL --}}
            <div>
                <p class="px-3 mb-1.5 text-[10px] font-semibold uppercase tracking-widest text-white/25">Operasional</p>
                <div class="space-y-0.5">
            ...
            {{-- KEUANGAN --}}
            <div>
                <p class="px-3 mb-1.5 text-[10px] font-semibold uppercase tracking-widest text-white/25">Keuangan</p>
                <div class="space-y-0.5">
                    <a href="{{ route('seller.wallet') }}"
                       class="sidebar-link {{ request()->routeIs('seller.wallet') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 12a2.25 2.25 0 0 0-2.25-2.25H15a3 3 0 1 1-6 0H5.25A2.25 2.25 0 0 0 3 12m18 0v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6m18 0V9M3 12V9m18 0a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 9m18 0V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v3"/>
                        </svg>
                        Dompet
                    </a>
                    <a href="{{ route('seller.withdrawals') }}"
                       class="sidebar-link {{ request()->routeIs('seller.withdrawals*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
